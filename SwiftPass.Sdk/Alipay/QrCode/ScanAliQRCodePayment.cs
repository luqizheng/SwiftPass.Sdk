...
{
    public class ScanAliQrCodePayment : RequestBase
    {
        public ScanAliQrCodePayment(string outTradeNo,string body,int totalFee, string mchCreateIp,string notifyUrl) : base("pay.alipay.native")
        {
        ...
        /// <summary>
        ///限制信用卡限定用户使用时能否使用信用卡，值为1，禁用信用卡，值为0或者不传此参数则不禁用是必填：否 
        /// </summary>
